  ...
  shortcuts: [
    {
      // 默认图标样式
      'icon-default':
        'color-textBaseColor transition-all ease-in active:scale-80 hover:text-primary',
      'icon-display': 'inline-block flex items-center justify-center',
      // 路由内容区域默认盒子样式
      'content-box-default': 'bg-bgPrimary rounded-lg shadow-sm p-6',
    },
  ],
  theme: {
    colors: {
      ...
      'primary-1': `rgb(var(--colorPrimary-value) / 0.1)`,
      'primary-2': `rgb(var(--colorPrimary-value) / 0.2)`,
      'primary-3': `rgb(var(--colorPrimary-value) / 0.3)`,
      'primary-4': `rgb(var(--colorPrimary-value) / 0.4)`,
      'primary-5': `rgb(var(--colorPrimary-value) / 0.5)`,
      'primary-6': `rgb(var(--colorPrimary-value) / 0.6)`,
      'primary-7': `rgb(var(--colorPrimary-value) / 0.7)`,
      'primary-8': `rgb(var(--colorPrimary-value) / 0.8)`,
      'primary-9': `rgb(var(--colorPrimary-value) / 0.9)`,
      // 错误色
